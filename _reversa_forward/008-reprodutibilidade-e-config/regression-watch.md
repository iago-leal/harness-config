...
| ID   | Veredito | Observação                                                                   |
| ---- | -------- | ---------------------------------------------------------------------------- |
| W001 | 🟢 verde | Blindagem de formatação inalterada; a 010 não tocou `formatting/service.py`. |
| W002 | 🟢 verde | Opt-out dinâmico (`config.formatting.opt_out_file`) inalterado.              |
| W003 | 🟢 verde | Glob matching (`fnmatch`) na exclusão inalterado.                            |
