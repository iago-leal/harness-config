...
- [ ] Pasta virtual `harness-core/.venv` configurada e dependências instaladas.
...
- [ ] T-01, Criar o esqueleto do serviço de documentação `DocumentationService`
  - Origem no legado: `harness-core/src/core/documentation/service.py:1`
...
- [ ] T-02, Criar o template HTML com design visual responsivo e JavaScript interativo
  - Origem no legado: `harness-core/src/core/documentation/template.html:1`
...
- [ ] T-03, Implementar introspecção recursiva do `argparse.ArgumentParser`
  - Origem no legado: `harness-core/src/core/documentation/service.py:11`
...
- [ ] T-04, Implementar extração de regras de negócio a partir do `domain.md`
  - Origem no legado: `harness-core/src/core/documentation/service.py:37`
...
- [ ] T-05, Implementar a geração atômica do arquivo HTML final
  - Origem no legado: `harness-core/src/core/documentation/service.py:67`
...
- [ ] T-06, Integrar os novos comandos `doc-gen` e `doc-serve` na CLI `main.py`
  - Origem no legado: `harness-core/src/main.py:175`
...
- [ ] T-07, Implementar o servidor HTTP local simples com `http.server`
  - Origem no legado: `harness-core/src/main.py:200`
