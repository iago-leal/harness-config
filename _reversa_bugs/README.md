...
> Gerado pelo Reversa em 2026-08-11. Este arquivo é o contrato do registro de bugs deste projeto.
...
> Nota da escolha: `local-software` foi adotado sem entrevista por ser a categoria evidente do
> harness (software local, suíte pytest com CI em 3.12/3.13). Troque aqui se discordar.
...
└── <contexto>/                  ex.: encerramento-de-sessao/
