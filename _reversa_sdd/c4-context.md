...
> **Reconciliação de 2026-07-05** (pós-features 009-021): no nível de Contexto, atores e sistemas externos não mudaram — a mudança relevante é interna ao "Sistema harness-core" (o split Shim/Upstream da feature 020, detalhado em `c4-containers.md`) e não altera esta fronteira de nível 1. Vale registrar que, desde a feature 020, o "Sistema harness-core" que o Humano e os agentes acionam por projeto é, na prática, um **shim fino** que delega a um core compartilhado no repositório upstream — a caixa permanece a mesma do ponto de vista externo, só sua composição interna mudou. `AntigravityHookBridge` (f009) já estava coberto pela linha "Antigravity" abaixo.
