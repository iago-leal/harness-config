...
> Regenerado pelo Detective em 2026-06-24 (Re-extração após a feature 008-reprodutibilidade-e-config)
...
- **Perfil de Harness (`HarnessProfile`):** Estratégia que encapsula o bloco de ganchos e as instruções de instalação de um agente.
