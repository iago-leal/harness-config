...
> **Reconciliação de 2026-07-15:** nenhuma pergunta nova. O delta MD-0014 + 022-023 nasceu de fichas de decisão completas (MD-0014/0015/0016, com descartes explícitos) e specs forward com esclarecimentos já respondidos pelo mantenedor nos `/reversa-clarify` das próprias features — não restou ambiguidade a validar. O registro informativo G-15 (itens `format` legados não podados) documenta uma decisão já tomada, não uma dúvida.
> **Reconciliação de 2026-08-11-b (feature 028):** nenhuma pergunta nova. O delta nasceu da ficha MD-0022 (com descartes explícitos: fragmentar fichas, comando novo, truncar o índice, regravar guidance no upgrade) e da spec forward da 028 com esclarecimentos já respondidos pelo mantenedor. O risco da guidance não retroativa é decisão aceita, não dúvida (ver `gaps.md#G-19`); nada aqui exige resposta escrita.
> **Reconciliação de 2026-08-11 (features 024-027):** nenhuma pergunta nova. O delta nasceu de fichas completas (MD-0017 a MD-0020, com descartes explícitos) e do clarify da 027 já respondido pelo mantenedor (D1: cards por ação + resumo por feature; D2: manuais preservados como canal de demandas; D3: board versionado em caminho configurável). A única validação pendente é **operacional**, não de especificação: a conferência visual do board no fork do vscode-kanban (registrada em `gaps.md#G-16`); nada aqui exige resposta escrita.
